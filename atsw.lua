...
atsw_currentinvslotfilter={};
atsw_invslotfilter={};
atsw_invslotfiltered={};
atsw_currentsubclassfilter={};
atsw_subclassfilter={};
...
function ATSWMerchant_InsertAutoBuyButton()
	...
	if Skinner and Skinner.initialized.MerchantFrames then
		ATSWAutoBuyButtonFrame:SetPoint("BOTTOMLEFT", "MerchantFrame", "BOTTOMLEFT" , 8, 24); 
		ATSWAutoBuyButtonFrame:SetWidth(327) 
		ATSWAutoBuyButtonFrame:SetHeight(54)
	else
		ATSWAutoBuyButtonFrame:SetBackdrop({ bgFile = "Interface\\DialogFrame\\UI-DialogBox-Background", tile = true, tileSize = 32, insets = {left = 0, right = 0, top = 0, bottom = 0},})
		ATSWAutoBuyButtonFrame:SetBackdropColor(0.9,0.9,0.9,1)
		ATSWAutoBuyButtonFrame:SetPoint("BOTTOMLEFT", "MerchantFrame", "BOTTOMLEFT" , 18, 84);
		ATSWAutoBuyButtonFrame:SetWidth(327)
		ATSWAutoBuyButtonFrame:SetHeight(54)
		-- ATSWAutoBuyButtonFrame:SetPoint("TOPLEFT", "MerchantFrame", "TOPLEFT" , 70, -32);
		-- ATSWAutoBuyButtonFrame:SetHeight(50)
		-- ATSWAutoBuyButtonFrame:SetWidth(275)
	end
